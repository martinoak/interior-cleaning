            ...
            <div class="col-lg-12">
                <nav class="navbar navbar-expand-lg">
                    <a class="navbar-brand fw-bold" href="/" style="color: white">
                        <img src="<?php echo e(asset('images/logo/logo.png')); ?>" alt="Logo" class="w-25"/>
                ...
                <div class="ud-single-testimonial">
                    ...
                    <div class="ud-testimonial-info">
                        <div class="ud-testimonial-image">
                            <img src="<?php echo e(asset('images/testimonials/author-01.png')); ?>" alt=""/>
                        </div>
                ...
                <div class="ud-single-team">
                    <div class="ud-team-image-wrapper">
                        <div class="ud-team-image">
                            <img src="<?php echo e(asset('images/team/team-01.png')); ?>" alt="team" />
                        </div>
                        <img
                            src="<?php echo e(asset('images/team/dotted-shape.svg')); ?>"
                            alt="shape"
                            class="shape shape-1"
                        />
                        <img
                            src="<?php echo e(asset('images/team/shape-2.svg')); ?>"
                            alt="shape"
                            class="shape shape-2"
                        />
                    </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-xl-4 col-lg-5">
                <div class="ud-contact-form-wrapper">
                    ...
                    <form class="ud-contact-form" method="post" action="<?php echo e(route('sendEmail')); ?>">
...
<?php /**PATH C:\Users\Admin\Desktop\GitHub\interior-laravel-tailwind\resources\views/index.blade.php ENDPATH**/ ?>