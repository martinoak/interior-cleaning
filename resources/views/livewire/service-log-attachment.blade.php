    ...
    @for($i = 1; $i <= $counter; $i++)
        <div class="mb-5">
            ...
            <div class="flex items-center space-x-4">
                <input class="block w-1/3 h-10 text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="attachments" type="file" name="attachments[]">
