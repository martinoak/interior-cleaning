                ...
                <div>
                    <div class="form-offset">
                        <div class="row-wrapper">
                            ...
                            <div>
                                <input type="text" name="name" id="name" autocomplete="off" value="{{ old('name') }}" class="max-w-2xl" required>
                            </div>
                        </div>
                        ...
                        <div class="row-wrapper">
                            ...
                            <div>
                                <input type="text" name="login" id="login" autocomplete="off" value="{{ old('login') }}" class="max-w-2xl" required>
                            </div>
                        </div>
                        ...
                        <div class="row-wrapper">
                            ...
                            <div>
                                <input id="password" type="password" name="password" value="{{ old('password') }}" class="max-w-2xl">
