        ...
        <form method="post" action="{{ route('vehicles.update', ['vehicle' => $vehicle->id]) }}" enctype="multipart/form-data">
            ...
            <div class="mb-5">
                ...
                <ul class="grid w-full gap-6 grid-cols-2 mt-2">
                    <li>
                        <input type="radio" id="car" name="type" value="car" class="hidden peer" @if(old('type', $vehicle->type) === 'car')checked @endif required />
                    ...
                    <li>
                        <input type="radio" id="truck" name="type" value="truck" class="hidden peer" @if(old('type', $vehicle->type) === 'truck')checked @endif>
