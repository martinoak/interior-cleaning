...
<nav class="px-2 sm:px-4 py-2.5 bg-blue-600">
    <div class="container flex flex-wrap justify-between items-center mx-auto">
        <a href="https://flowbite.com/" class="flex items-center">
            <img src="{{ asset('images/logo/logo.png') }}" class="mr-3 h-6 sm:h-9" alt="Flowbite Logo" />
            <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Čištění interiéru Kondrac</span>
        </a>
        <button data-collapse-toggle="navbar-default" type="button" class="inline-flex items-center p-2 ml-3 text-sm text-gray-500 md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-default" aria-expanded="false">
            <span class="sr-only">Open main menu</span>
            <svg class="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 15a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" clip-rule="evenodd"></path></svg>
        </button>
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul class="flex flex-row space-x-8 p-4 mt-4 bg-blue-600 md:mt-0 font-medium text-large">
                <li>
                    <a href="#" class="block py-2 pr-4 pl-3 text-white rounded hover:text-gray-300 md:hover:bg-transparent md:border-0 md:p-0 dark:hover:bg-gray-700">O mně</a>
                </li>
                <li>
                    <a href="#" class="block py-2 pr-4 pl-3 text-white rounded hover:text-gray-300 md:hover:bg-transparent md:border-0 md:p-0 dark:hover:bg-gray-700">Tým</a>
                </li>
                <li>
                    <a href="#" class="block py-2 pr-4 pl-3 text-white rounded hover:text-gray-300 md:hover:bg-transparent md:border-0 md:p-0 dark:hover:bg-gray-700">Reference</a>
                </li>
                <li>
                    <a href="#" class="block py-2 pr-4 pl-3 text-white rounded hover:text-gray-300 md:hover:bg-transparent md:border-0 md:p-0 dark:hover:bg-gray-700">Ceník</a>
                </li>
                <li>
                    <a href="#" class="block py-2 pr-4 pl-3 text-white rounded hover:text-gray-300 md:hover:bg-transparent md:border-0 md:p-0 dark:hover:bg-gray-700">Kontakty</a>
                </li>
            </ul>
        </div>
    </div>
...
<!-- ====== Hero Section Start -->
<section class="ud-hero bg-blue-600" id="home" style="padding: 50px 0">
    <div class="container mx-auto text-center">
        <div class="flex flex-row justify-center">
            <div>
                ...
                <p class="text-white text-xl py-5">
                    Práce všeho druhu
                </p>
            </div>
        </div>
...
<section id="features" class="pt-20 pb-8 lg:pt-[120px] lg:pb-[70px]">
    <div class="container mx-auto">
        <div class="flex flex-col mb-12 max-w-[620px] lg:mb-20 gap-y">
                <span class="font-bold text-lg text-blue-600 mb-2.5">
                Služby
                </span>
            <h2
                class="mb-4 text-3xl font-bold text-gray-800 sm:text-4xl md:text-[42px]"
            >
                Tohle vše dokážu zařídit
            </h2>
            <hr>
        </div>
